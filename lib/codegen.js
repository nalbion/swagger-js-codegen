...
var getViewForSwagger2 = function(opts, type){
    ...
    var data = {
        isNode: type === 'node',
        isClosure: type === 'angular-closure',
...
var getCode = function(opts, type) {
    ...
    //    if(error.code[0] === 'E') {
    //        console.error(lint.errors[0].reason + ' in ' + lint.errors[0].evidence);
...
exports.CodeGen = {
    ...
    getAngularClosureCode: function(opts){
        return getCode(opts, 'angular-closure');
    },
